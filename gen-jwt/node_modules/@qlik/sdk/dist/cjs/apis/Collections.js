...
__export(Collections_exports, {
  ...
  CollectionsAddCollectionItemRequestBody: () => CollectionsAddCollectionItemRequestBody,
  CollectionsCreateCollectionRequestBody: () => CollectionsCreateCollectionRequestBody,
  CollectionsLinksResponseBody: () => CollectionsLinksResponseBody,
  CollectionsListCollectionItemsResponseBody: () => CollectionsListCollectionItemsResponseBody,
  CollectionsListCollectionsResponseBody: () => CollectionsListCollectionsResponseBody,
  CollectionsUpdateCollectionRequestBody: () => CollectionsUpdateCollectionRequestBody,
...
class CollectionResultResponseBody {
  ...
  async getItems(queryParams = { limit: 10 }) {
    const response = await this.auth.rest(
      `${"/collections/{collectionId}/items".replace("{collectionId}", this.id ?? "")}?${Object.entries(queryParams).filter(([, v]) => v !== void 0).map(([k, v]) => `${k}=${v}`).join("&")}`,
      {
        method: "GET"
      }
    );
    const responseJson = await response.json();
    return new CollectionsListCollectionItemsResponseBody(responseJson, this.auth);
  }
...
class Collections {
  ...
  async deleteItem(collectionId, itemId) {
    await this.auth.rest(
      "/collections/{collectionId}/items/{itemId}".replace("{collectionId}", collectionId).replace("{itemId}", itemId),
      {
        method: "DELETE"
      }
    );
  ...
  async getCollections(queryParams = {}) {
    const response = await this.auth.rest(
      `/collections?${Object.entries(queryParams).filter(([, v]) => v !== void 0).map(([k, v]) => `${k}=${v}`).join("&")}`,
      {
        method: "GET"
      }
    );
    const responseJson = await response.json();
    return new CollectionsListCollectionsResponseBody(responseJson, this.auth);
  }
  async create(data) {
    const response = await this.auth.rest(
      "/collections",
